...
from keras.layers import Input, Dense, Dropout, Reshape, AveragePooling2D, AveragePooling3D, AveragePooling1D
...
def load_data(data_path):
    ...
    for i in tqdm(range(num_files),ncols=80): #num_files
        ...
        labels = np.load(full_path + '_label.npy') # keep as label
